...
\begin{document}
	...
	\subsection{Deskripsi Fitur}
		\input{deskripsi_registrasi}
	\subsection{Kebutuhan Fungsional}
		\input{kebutuhan_anggota}
	\section{Fasilitas Kesehatan}
	\subsection{Deskripsi Fitur}
		\input {deskripsi_faskes}
	\subsection{Kebutuhan Fungsional}
		\input{kebutuhan_faskes}
	\section{Iuran Jaminan Kesehatan}
	\subsection{Deskripsi Fitur}
		\input {deskripsi_iuran}
	\subsection{Kebutuhan Fungsional}
		\input{kebutuhan_iuran}
	\section{Penggunaan Layanan Kesehatan}
	\subsection{Deskripsi Fitur}
		\input{deskripsi_penggunaan}
	\subsection{Kebutuhan Fungsional}
		\input{kebutuhan_penggunaan}
	\end{document}
\end{document}
